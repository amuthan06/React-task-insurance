...
const PolicyholdersBasedOnRegionChart = ({ policyholders }: PolicyholdersBasedOnRegionChartProps) => {
  // Aggregate data: count of policyholders by region
  const data = policyholders.reduce((acc: { region: string; count: number }[], ph) => {
  ...
  return (
    <div className="mb-6">
      <h3 className="text-lg font-semibold mb-2">Policyholders Based on Region</h3>
